                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="old_image" value="{{ $editCategory->category_image }}">

                            <div class="col-sm-10">
                                <img id="showImage" class="rounded-circle avatar-lg" src="{{ asset($editCategory->category_image) }}" 
