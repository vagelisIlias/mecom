          ...
          <hr/>
            ...
            <form id="myForm" method="post" action="{{ route('store.product') }}" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3" style="border: 2px dashed #ccc; padding: 40px; text-align: center; position: relative;">
                    <input name="multi_image[]" id="multi_image" class="form-control @error('multi_image.*') is-invalid @enderror" type="file" multiple style="display: none;" onchange="previewMultiImage(this)">
                ...
                {{-- Thumbnail Image --}}
                <div class="form-group mb-3" style="border: 2px dashed #ccc; padding: 40px; text-align: center; position: relative;">
                    <input name="product_thambnail" id="product_thambnail" class="form-control @error('product_thambnail') is-invalid @enderror" type="file" style="display: none;" onchange="previewThumbnailImage(this)">
