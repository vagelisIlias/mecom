                    ...
                    <div class="card">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                {{-- Form starts here --}}
                                <form class="row g-3" id="myForm" method="post" action="{{ route('update.vendor.profile') }}" enctype="multipart/form-data">
                                    @csrf
                                    
                                    <input type="hidden" name="id" value="{{ $editVendorDetails->id }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="firstname" class="form-control border-start-0" id="inputLastName1" value="{{ $editVendorDetails->firstname }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text bg-transparent"><i class="fa-solid fa-user"></i></span>
                                            <input type="text" name="lastname" class="form-control border-start-0" id="inputLastName2" value="{{ $editVendorDetails->lastname }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="username" class="form-control border-start-0" id="inputPhoneNo" value="{{ $editVendorDetails->username }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="email" name="email" class="form-control border-start-0" id="inputEmail" value="{{ $editVendorDetails->email }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="vendor_shop_name" class="form-control border-start-0" id="inputShopName" value="{{ $editVendorDetails->vendor_shop_name }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="phone" class="form-control border-start-0" id="inputPhoneNumber" value="{{ $editVendorDetails->phone }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="address" class="form-control border-start-0" id="inputAddress" value="{{ $editVendorDetails->address }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="postcode" class="form-control border-start-0" id="inputPostCode" value="{{ $editVendorDetails->postcode }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="vendor_join" class="form-control border-start-0" id="inputPostCode" value="{{ $editVendorDetails->vendor_join }}">
                                        </div>
                                    </div>

                                    <div class="col-12">
                                        <button type="submit" id="submit-button" class="btn btn" style="background-color: rgb(202, 18, 177); color: white;">Update Vendor Profile</button>
                                    </div>
