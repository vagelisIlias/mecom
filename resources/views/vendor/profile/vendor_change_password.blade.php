                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded-circle avatar-lg" src="{{ (!empty($vendorChangePassword->photo)) ? url('upload/vendor_profile_image/'. $vendorChangePassword->photo) : url('upload/no_image.jpg') }}" alt="Card image cap" style="width: 100px; height: 100px; border: 5px solid rgba(138, 60, 221, 0.729);">
                                    </div>
                                    <div class="mt-3">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        <a href="{{ $vendorChangePassword->github }}" class="text-decoration-none" target="_blank">
                                            <h6 class="mb-0">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        <a href="{{ $vendorChangePassword->instagram }}" class="text-decoration-none" target="_blank">
                                            <h6 class="mb-0">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        <a href="{{ $vendorChangePassword->linkedin }}" class="text-decoration-none" target="_blank">
