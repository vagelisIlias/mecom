                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded-circle avatar-lg" src="{{ (!empty($vendorProfile->photo)) ? url('upload/vendor_profile_image/'. $vendorProfile->photo) : url('upload/no_image.jpg') }}" alt="Card image cap" style="width: 50px; height: 50px; border: 2px solid rgba(138, 60, 221, 0.729);">
                                    </div>
                                    <div class="mt-3">
                                        <h4>{{ $vendorProfile->firstname }} {{ $vendorProfile->lastname }}</h4>
                                        <p class="text-secondary mb-1">{{ $vendorProfile->job_title }}</p>
                                        <p class="text-muted font-size-sm">{{ $vendorProfile->email }}</p>
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        <a href="{{ $vendorProfile->github }}" class="text-decoration-none" target="_blank">
                                            <h6 class="mb-0">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" class="form-control" name="github" value="{{ $vendorProfile->github }}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" class="form-control" name="role" value="{{ $vendorProfile->role }}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
