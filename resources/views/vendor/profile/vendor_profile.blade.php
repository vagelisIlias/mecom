                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <label 
                                    for="example-text-input" class="col-sm-2 col-form-label">
                                </label>
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded-circle" src="{{ (! empty($user->photo)) ? 
                                        url($user->photo) : url('no_image.jpg') }}" 
                                    >
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3" id="myForm" method="POST" 
                                    action="{{ route('vendor.profile.update', ['user' => $user->id]) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
